...
- 출력: pipeline/bronze/public_{YYYYMMDD}_성수뚝섬건대_시간대별_승하차.csv

코드 의미: Docs/Public_Data_api/getStnPsgr_코드_참조.md

사용 예:
  python pipeline/extractors/subway_public.py -d 20260225
  python pipeline/extractors/subway_public.py -d 20260225 --detail
"""
