...
- 출력: pipeline/bronze/seoul_subway_{YYYYMM}_분당선_서울숲_시간대별_승하차.csv

참고: Docs/서울열린데이터광장/분당선_서울열린데이터_추가_가능여부_검토.md

사용 예:
  python pipeline/extractors/subway_seoul.py -m 202601
  python pipeline/extractors/subway_seoul.py -m 202601 --append pipeline/bronze/public_20260225_...상세_카드권종별.csv
"""
...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="FILE",
        help="기존 CSV에 append (예: pipeline/bronze/public_20260225_...상세_카드권종별.csv)",
    )
